...
class CalorieCalculator {
    ...
    private fun metFor(activityType: ActivityType, speedMetersPerSecond: Float): Double {
        ...
        return when (activityType) {
            ActivityType.Walking -> metForWalking(speedKmh)

            ActivityType.Running -> metForRunning(speedKmh)

            ActivityType.Cycling -> metForCycling(speedKmh)
        }
    }

    private fun metForCycling(speedKmh: Double): Double = when {
        speedKmh < 16.0 -> 4.0
        speedKmh < 19.2 -> 6.8
        speedKmh < 22.4 -> 8.0
        speedKmh < 25.6 -> 10.0
    ...
    private fun metForWalking(speedKmh: Double): Double = when {
        speedKmh < 3.2 -> 2.0
        speedKmh < 4.5 -> 2.8
        speedKmh < 5.1 -> 3.5
        speedKmh < 5.6 -> 4.3
    ...
    private fun metForRunning(speedKmh: Double): Double = when {
        speedKmh < 8.0 -> 8.3
        speedKmh < 9.7 -> 9.0
        speedKmh < 10.8 -> 9.8
        speedKmh < 11.3 -> 10.5
